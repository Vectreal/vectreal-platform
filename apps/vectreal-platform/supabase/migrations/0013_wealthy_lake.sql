...
ALTER TABLE "scene_settings" ADD COLUMN "object_overrides" json;--> statement-breakpoint
ALTER TABLE "scene_settings" ADD COLUMN "placeables" json;--> statement-breakpoint
