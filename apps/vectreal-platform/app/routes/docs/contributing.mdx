...
See [Installation](/docs/self-hosting/installation) to get a fully working local dev environment.
...
- [Installation](/docs/self-hosting/installation) - contributor onboarding baseline
- [Deployment](/docs/self-hosting/deployment) - infra/runtime context for platform changes
