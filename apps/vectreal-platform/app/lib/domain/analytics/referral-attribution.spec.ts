...
type TestGlobalThis = typeof globalThis & {
  __testStore?: Record<string, string>
  __testLocalStorageMock?: LocalStorageMock
}
...
beforeEach(() => {
  ...
  ;(globalThis as TestGlobalThis).__testStore = store
  ;(globalThis as TestGlobalThis).__testLocalStorageMock = localStorageMock
})

afterEach(() => {
  vi.unstubAllGlobals()
  delete (globalThis as TestGlobalThis).__testStore
  delete (globalThis as TestGlobalThis).__testLocalStorageMock
})

function getStore(): Record<string, string> {
  return (globalThis as TestGlobalThis).__testStore!
}

function getLocalStorageMock(): LocalStorageMock {
  return (globalThis as TestGlobalThis).__testLocalStorageMock!
}
