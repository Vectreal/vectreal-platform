...
if [ ! -f "$ENV_FILE" ]; then
    ...
    echo "  - SUPABASE_PUB_KEY_PROD / SUPABASE_PUB_KEY_STAGING"
...
gh secret set SUPABASE_PUB_KEY_PROD --body "$SUPABASE_PUB_KEY_PROD"
...
gh secret set SUPABASE_PUB_KEY_STAGING --body "$SUPABASE_PUB_KEY_STAGING"
