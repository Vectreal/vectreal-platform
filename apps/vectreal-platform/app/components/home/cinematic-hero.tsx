...
export function CinematicHero() {
	...
	// Scroll-driven hand-off: text rises and fades, 3D sinks + scales as you leave the hero
			...
			<div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-8 px-6 lg:grid-cols-2 lg:gap-4">
				...
				>
					...
					>
						...
						<motion.h1
							variants={prefersReducedMotion ? undefined : fadeUp}
							className="text-display text-foreground flex flex-col"
						>
							<span>Upload.</span>
							<span>Prepare.</span>
				...
				{/* 3D column — above the text on mobile, right on desktop. No
				    scroll-driven transform: scaling the canvas wrapper forces the
				    viewer to re-fit and snaps the model. */}
				<motion.div
				...
				>
					...
					<div
						className="absolute top-1/2 left-1/2 -z-10 h-[55%] w-[55%] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[80px]"
						style={{
							background:
					...
					{/* Orbital rings — desktop only (cramped on mobile) */}
					<div
