			...
			<Body style={s.body}>
				<Container style={s.container}>
					...
					<Section style={s.content}>
						...
						<Text style={s.intro}>
							A contact form submission just came in. Reply directly to this
							email - it&apos;s set to reach {name} at their inbox.
						</Text>
								...
								<tbody>
									...
									<tr>
										...
										<td style={s.dataValue}>
											<Link href={`mailto:${email}`} style={s.emailLink}>
												{email}
											</Link>
										</td>
									</tr>
						...
						<Text style={s.outro}>
							Hit reply to respond directly to {name}. The Reply-To header is
					...
					<Section style={s.footer}>
						<Text style={s.footerLegal}>
							{'© '}
							{year}
							{' Vectreal · Internal notification - do not forward'}
						</Text>
					</Section>
				</Container>
			</Body>
