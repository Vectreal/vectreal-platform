...
Toggle the floor grid and adjust its appearance:

| Option | Description |
|---|---|
| `showGrid` | Show or hide the grid |
| `cellSize` | Size of individual grid cells |
| `sectionSize` | Size of major grid sections |
| `cellColor` | Minor grid line color |
