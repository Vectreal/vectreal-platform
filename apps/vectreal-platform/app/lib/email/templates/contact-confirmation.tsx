...
export function ContactConfirmationEmail({
  ...
  return (
    <Html lang="en" dir="ltr">
      ...
      <Preview>We&apos;ve received your {label} inquiry and will be in touch soon.</Preview>
      ...
      <Body style={s.body}>
        <Container style={s.container}>
          ...
          <Section style={s.content}>
            ...
            <Text style={s.intro}>
              Thanks for reaching out. Your {label} inquiry is with our team — we&apos;ll get back to you within one business day. Usually sooner.
            </Text>
            ...
            <Text style={s.outro}>
              Need to follow up? Reply to this email with your reference code and we&apos;ll pick up the thread. You can also reach us directly at{' '}
              <Link href="mailto:info@vectreal.com" style={s.link}>info@vectreal.com</Link>.
            </Text>
          </Section>
